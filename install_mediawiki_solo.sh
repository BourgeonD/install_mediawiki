...
read -p "Indiquer le nom du nouveau ou de l'actuelle fichier de conf de site: " name_conf_site
...
<VirtualHost *:443>
    ...
    ' >> /etc/apache2/sites-available/$name_conf_site
else
    echo '
<VirtualHost *:80>
        ServerName '$name_server'.ciml.cnrs
